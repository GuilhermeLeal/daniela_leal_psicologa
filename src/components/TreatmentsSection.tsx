...
const TreatmentsSection = () => {
  ...
  return <section id="tratamentos" className="py-20 lg:py-32 bg-cream-dark">
      <div className="section-container">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {treatments.map((treatment, index) => <div key={index} className="card-treatment">
        ...
        <div className="text-center">
          <a href="#contato" className="inline-block border-2 border-mocha text-mocha px-8 py-3 text-sm tracking-wider hover:bg-mocha hover:text-cream transition-all duration-300">
            Transtornos do jogo 
          </a>
        </div>
      </div>
